...
- [ ] Guest Home shows marketing/hero info ("Create stories generated by AI") alongside Public Stories grid

**Subtasks (TDD sequence)**:
- [ ] 3.1.2a.1 Tests — useStories composable (fetchPublic, fetchMine, newest-first, pagination math, error propagation)
- [ ] 3.1.2a.2 Implement — useStories queries and types
- [ ] 3.1.2b.1 Tests — Home integration: guest marketing+grid, auth two grids, Show more appends 12, infinite continuation, loading/empty
- [ ] 3.1.2b.2 Implement — Home wiring with “Show more” and infinite scroll
- [ ] 3.1.2c.1 Tests — StoryFilters: search debounce, type/date/privacy filters
