...
Hosted on [GitHub Pages](https://ljacobdev.github.io/story-starter)

**Note: This site is viewable on mobile, but currently signing in using mobile seems to have issues.**
