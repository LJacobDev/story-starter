...
// DEV flag to show demo only in development
  ...
  <div class="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
        ...
        <div class="flex justify-between items-center h-16">
          ...
          <nav class="flex items-center space-x-2 sm:space-x-4">
            ...
            <template v-else>
              ...
              <!-- Demo stays as the 3rd button to satisfy tests when running without router. Render only in dev -->
              <button 
                v-if="isDev"
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div v-else>
        ...
        <div v-else-if="currentView === 'demo'" class="space-y-8">
          <div class="bg-gradient-to-br from-pink-500 via-purple-600 to-blue-700 rounded-2xl p-8">
            <div class="text-center space-y-4">
              <h1 class="text-4xl md:text-6xl font-black text-white mb-2">Tailwind Demo</h1>
              <p class="text-white/90 text-lg font-semibold">Gradients, animations and utilities are available.</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
              <div class="bg-white/20 backdrop-blur rounded-xl p-6 shadow-xl border border-white/30">
                <div class="w-12 h-12 mx-auto mb-4 bg-gradient-to-r from-green-400 to-blue-500 rounded-full animate-spin" aria-hidden="true"></div>
                <h3 class="text-white text-xl font-bold text-center mb-2">Colors</h3>
                <p class="text-center text-green-200">Gradients & spinning animation</p>
              </div>
              <div class="bg-white/20 backdrop-blur rounded-xl p-6 shadow-xl border border-white/30">
                <h3 class="text-white text-xl font-bold text-center mb-2">Typography</h3>
                <div class="mt-2 space-y-1 text-center">
                  <div class="text-xs text-gray-200">Extra Small</div>
                  <div class="text-sm text-gray-100">Small</div>
                  <div class="text-base text-white">Base</div>
                  <div class="text-lg text-yellow-200">Large</div>
                </div>
              </div>
              <div class="bg-white/20 backdrop-blur rounded-xl p-6 shadow-xl border border-white/30">
                <div class="w-10 h-10 mx-auto mb-4 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-lg animate-bounce" aria-hidden="true"></div>
                <h3 class="text-white text-xl font-bold text-center mb-2">Effects</h3>
                <p class="text-center text-purple-200">Shadows, blur & bounce</p>
              </div>
            </div>
            <div class="flex flex-wrap justify-center gap-4 mt-8">
              <span class="px-4 py-2 bg-green-500 text-white rounded-full font-semibold">Responsive</span>
              <span class="px-4 py-2 bg-blue-500 text-white rounded-full font-semibold">Modern CSS</span>
              <span class="px-4 py-2 bg-purple-500 text-white rounded-full font-semibold">Utilities</span>
            </div>
          </div>
          ...
          <div class="text-center bg-white dark:bg-slate-800 rounded-xl p-8 shadow-lg border border-slate-200 dark:border-slate-700">
            <div class="flex justify-center gap-8 mb-6">
              ...
              <img :src="vueLogo" alt="Vue" class="w-16 h-16" />
            </div>
